...
# Replace "Climate_Change" with "aClimate_Change" and drop unused levels
df2$Term <- factor(replace(as.character(df2$Term), df2$Term == "Climate_Change", "aClimate_Change"))
df2$Term <- droplevels(df2$Term)
```
