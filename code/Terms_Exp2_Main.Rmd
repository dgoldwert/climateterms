...
tukey_test <- glht(M, linfct = mcp(C = "Tukey"))
...
contrast_test <- glht(M, linfct = mcp(C = contrasts))
...
```{r edu}
M <- lm(Act ~ C*Education, data = df2c)
