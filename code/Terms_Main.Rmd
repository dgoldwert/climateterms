...
generate_lm_model_and_latex_output(M, "willingness", "../overleaf/tabs/US.tex")
print(summary(M))
confint(M)
...
generate_model_and_latex_output(M, "willingness", "../overleaf/tabs/anglo.tex")
print(summary(M))
confint(M)
