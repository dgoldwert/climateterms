    \subsection{Additional Exploratory Analyses in Experiment 1 (All 63 Countries)}
...
\input{overleaf/tabs/exp_trustsci1} 
\end{table}
...
\input{overleaf/tabs/exp_trustsci2} 
\end{table}
...
\input{overleaf/tabs/exp_trustgov} 
\end{table}
...
\input{overleaf/tabs/exp_carehumwel} 
\end{table}
...
\input{overleaf/tabs/exp_globalcitizen} 
\end{table}
...
\input{overleaf/tabs/exp_envirid} 
\end{table}
...
\input{overleaf/tabs/exp_envirmot} 
\end{table}
...
\input{overleaf/tabs/exp_plurig} 
\end{table}
...
\input{overleaf/tabs/exp_scicons} 
\end{table}
